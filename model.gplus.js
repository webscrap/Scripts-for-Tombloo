 ...
 * 
 * Tombloo model for posting links and photos to Google+ Circles.
 * --------------------------------------------------------------------------
 *
 * @version		1.2
 * @date		2012-09-22
 ...
 * @updateURL	https://github.com/webscrap/Scripts-for-Tombloo/raw/master/model.gplus.js
 * 
 * --------------------------------------------------------------------------
 * Base on codes below:
 * 
 ** #1 Model.Google+.Circle - Tombloo patches
 **
 ** @version    1.13
 ** @date       2011-11-19
 ...
 ** @source  https://github.com/polygonplanet/tombloo/raw/master/tombloo.model.googleplus.circle.js
 **
 **
 ** #2 Model.Google+ for Tombloo
 **
 ** @version : 1.1
 ** @date    : 2011-11-17
 ** @author  : YungSang (http://yungsang.com/+)
 ** @source	: https://github.com/webscrap/Scripts-for-Tombloo
 *
 * --------------------------------------------------------------------------
 *
 *
...
models.register({
	...
	check : function(ps) {
		// Bookmark対応 + file
        return /(?:regular|photo|quote|link|video|bookmark)/.test(ps.type);
	},
    ...
    createCircleScopeSpar : function(circles,oz) {
		if(circles && circles.length) {
			...
			return this.createScopeSpar(oz);
		}
    },
    ...
    _post : function(ps, oz, circles) {
        ...
        return this.upload(ps, oz).addCallback(function() {
            ...
            spar.push(null);
			spar.push(self.createCircleScopeSpar(circles,oz));
